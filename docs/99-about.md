...
Those two projects were largely complete in late 2025, and it was time to start working on another one. VXLAN/EVPN seemed like a no-brainer; welcome to the [Open-Source VXLAN/EVPN Configuration Labs](https://evpn.bgplabs.net/) project.
...
[^ON]: Or not, depending on where you're standing ;)
